let data = {
  ...
  summer: {
    ...
    p3: "Але Якщо  це вже сталося, згадайте про Кремген UNI! Нанесіть Кремген UNI тонким шаром на подразнену ділянку шкіри – свою або малечі – та компоненти Кремген UNI допоможуть у її зволоженні та відновленні.",
  },
  autumn: {
